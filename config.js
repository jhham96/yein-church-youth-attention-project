...
const CONFIG = {
  // 1. 앱스 스크립트 웹 앱 URL
  SCRIPT_URL:
    "https://script.google.com/macros/s/AKfycbytlNQTCfms3b5KGJ9unwawMaV5hWM9o5OFiIPxL16zebQk_yaH5izMahQezqMDXUX_6g/exec",
...
const PATCH_NOTES = [
  {
    ...
    date: "2026-04-05",
    changes: [
      "GPS 실패시 거리정보 같이 전달하여 우선적으로 출석할수 있도록 수정.",
    ],
  },
  {
    version: "v1.4",
